package com.nickjwhite12.recipe_project.bootstrap;

import com.nickjwhite12.recipe_project.model.*;
import com.nickjwhite12.recipe_project.repositories.CategoryRepository;
import com.nickjwhite12.recipe_project.repositories.RecipeRepository;
import com.nickjwhite12.recipe_project.repositories.UnitOfMeasurementRepository;
...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private final String UOMNOTFOUNDEXC = "Expected UOM Not Found";
    private final String CATNOTFOUNDEX = "Expected Category Not Found";


    public DataLoader(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasurementRepository unitOfMeasurementRepository) {
    ...
    private List<Recipe> getRecipes(){
        ...
        //get UOMs
        Optional<UnitOfMeasurement> eachUomOptional = unitOfMeasurementRepository.findByUnitOfMeasure("Each");

        if(!eachUomOptional.isPresent()){
            throw new RuntimeException(UOMNOTFOUNDEXC);
        }

        Optional<UnitOfMeasurement> tablespoonUomOptional = unitOfMeasurementRepository.findByUnitOfMeasure("Tablespoon");

        if(!tablespoonUomOptional.isPresent()){
            throw new RuntimeException(UOMNOTFOUNDEXC);
        }

        Optional<UnitOfMeasurement> teaspoonUomOptional = unitOfMeasurementRepository.findByUnitOfMeasure("Teaspoon");
        ...
        Optional<UnitOfMeasurement> dashUomOptional = unitOfMeasurementRepository.findByUnitOfMeasure("Dash");
        ...
        Optional<UnitOfMeasurement> pintUomOptional = unitOfMeasurementRepository.findByUnitOfMeasure("Pint");

        if(!pintUomOptional.isPresent()){
            throw new RuntimeException(UOMNOTFOUNDEXC);
        }

        Optional<UnitOfMeasurement> cupUomOptional = unitOfMeasurementRepository.findByUnitOfMeasure("Cup");
        ...
        if(!americanCategoryOptional.isPresent()){
            throw new RuntimeException(CATNOTFOUNDEX);
        }
